...
/**
 * @author Shulan Yang
 * Class represents the strategy with type B by the fllowing method
...
public class BStrategy extends AbstractStrategy {
	...
	/**
	 * creates a strategy with type B for the publisher
	 */
	protected BStrategy() {
		listOfChannels = new ArrayList<String>();
		defaultEventType = EventType.TypeA;
		defaultHeader = "B | Default Message Header";
		defaultBody = "B | Default Message Body";
