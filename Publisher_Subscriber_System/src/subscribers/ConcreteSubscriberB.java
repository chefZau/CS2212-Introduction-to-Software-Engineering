...
/**
 * @author yansheng Xie
 * concrate the subscriber B ,we also extend from the sbstractSubscriber 
 * the subscriber have it own state 
 */
class ConcreteSubscriberB extends AbstractSubscriber {

	
	protected ConcreteSubscriberB(long subscriberID) {
		state = StateFactory.createState(StateName.bstate);
